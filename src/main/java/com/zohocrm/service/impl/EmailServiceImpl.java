...
public class EmailServiceImpl implements EmailService {
    ...
    public EmailServiceImpl(EmailRepository emailRepo, JavaMailSender javaMailSender, ModelMapper modelMapper, ContactRepository contactRepo, LeadRepository leadRepo) {
